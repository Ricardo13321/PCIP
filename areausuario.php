...
$disable_data = false;
if (isset($_SESSION['date'][0])) {
    $datesplit = explode('/', $_SESSION['date'][0]);
} else {
    $disable_data = true;
}

//Esta parte é responsável por pegar os objetos date e separálos para que eu cosiga setar o value atual nos input
$_loc1_ = $_SESSION['data_final'];
$_loc2_ = explode('-', $_loc1_);
$_loc3_ = $_SESSION['data_inicial'];
$_loc4_ = explode('-', $_loc3_);
?>
<!DOCTYPE html>
<html lang="pt-br">
...
<body style="overflow: hidden;">
    ...
    <div id="conteudo" class="d-flex h-90 w-100 align-items-stretch">
        ...
        <div id="container-principal" class="h-90 w-100 transition-right ">
            <div id="nav-control">
                <?php include "view/menucontrole.php"; ?>
            </div>
            <iframe name="panel" id="painel" src="view/dashboard.php" class="w-100 h-100"></iframe>
        </div>
    </div>

    <?php
    include "view/modalcadastrarentrega.php";
    include "view/modalsalvar.php";
    include "view\confirmardadossalvos.php";
    ?>
</body>
...
<script language="javascript" type="text/javascript">
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const btn_burguer = document.getElementById('burguer');
        const input_url = document.getElementById('input_url');
        const input_url2 = document.getElementById('input_url2');
        ...
        btn_atualizar.addEventListener('click', function() {
            window.frames['panel'].location.reload();
        });
        btn_burguer.addEventListener('click', function() {
