    ...
    <div style="overflow-x: hidden; overflow-y: auto;" class=" h-auto w-100">
            <div class="text-center">
                    <div class="row g-2">
                        ...
                        <div class="col-9">
                            <iframe class="border  rounded-border" src="../graficos/graficolinha.php" style="height: 500px; width: 100%;"></iframe>
                        </div>
                        <div class="col col-sm-3">
                            <div class="row g-2 justify-content-center">
                                <div class="rounded-border col-12 p-2 ">
                                ...
                                <iframe class="rounded-border col-12 " src="../graficos/graficoproducao.php" style="height: 200px;"></iframe>
                            </div>
                        </div>
                        <div class="col-6">
                            <iframe class="border  rounded-border" src="../graficos/graficoprodfuncionarios.php" style="height: 500px; width: 100%;" frameborder="0"></iframe>
                        </div>
                        <div class="col-6">
                            <iframe class="col-6 border  rounded-border" src="../graficos/graficoperformance.php" style="height: 500px; width: 100%;"></iframe>
                        </div>
                    </div>
            </div>
        </div>
